from covid.misc import laplacian, cases_to_intercepts, cases_to_beta
...
class SIR:
    ...
    def initialize(self):
        ...
        vals=cases_to_intercepts(self.data,self.params)   
        v=self.init_vals
        v.I=vals['I']
        v.R=vals['D']+vals['R']
        v.S=v.N-v.I-v.R
    ...
    def update_parameters(self):
        ...
        self.params=cases_to_beta(self.data,self.params,self.init_vals)
        self.param_fit()
...
class SEAIQHRD:
    ...
    def update_parameters(self):
        self.update_data()
        self.params=cases_to_beta(self.data,
                                             self.params,
                                             self.init_vals)
